...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "2f9b43af-8322-4932-b489-0c819dfc3abe",
...
const _lazy_HfUVLB = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_HfUVLB, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_HfUVLB, lazy: true, middleware: false, method: undefined }
];
